                ...
                >
                            ...
                            <div className="flex flex-col gap-4">
                              ...
                              <div className="text-xl sm:text-2xl font-bold flex items-center justify-end gap-2">
                                {/* Show original price with line-through if discounted */}
                                {order.cart?.items?.some(
                                (item) =>
                                  item.product?.discountedPrice &&
                                  item.product?.price &&
                                  item.product.discountedPrice < item.product.price
                                ) && (
                                <span className="text-gray-200 line-through text-base font-normal">
                                  ₹
                                  {order.cart?.items
                                  ?.reduce(
                                    (total, item) =>
                      ...
                      <div key={item._id || index} className="flex justify-between items-center p-2 bg-gray-50 rounded">
                        ...
                        <div className="text-right">
                          ...
                          <span className="font-semibold">
                            ₹{(item.product?.discountedPrice || item.product?.price || 0)?.toLocaleString()}
                          </span>
                          {item.quantity > 1 && (
