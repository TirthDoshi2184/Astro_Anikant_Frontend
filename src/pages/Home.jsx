...
import { GiChainedHeart, GiBallPyramid, GiTreeBranch, GiCutDiamond, GiGemPendant, GiTortoise, GiPrayerBeads, GiGemNecklace, GiDiamondRing } from 'react-icons/gi';
import { TbGeometry } from 'react-icons/tb';
import { IoKeyOutline } from 'react-icons/io5';
import { BsImageAlt, BsBox } from 'react-icons/bs';
...
const HomePage = () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:1921/productrequest/insertproductrequest",
        {
          ...
          additionalDetails:
            formData.additionalInfo || "No additional details provided",
        }
      );

      if (response.status === 201) {
        alert(
          "Thank you! Your product inquiry has been submitted. Our team will contact you soon."
        );
        // Reset form
        setFormData({
          productName: "",
  ...
  // Add these state variables after existing useState declarations (around line 90)
  const [categorySlide, setCategorySlide] = useState(0);

  const getCategoriesPerSlide = () => {
    if (window.innerWidth < 768) return 1; // Mobile: 1 per slide
    if (window.innerWidth < 1024) return 3; // Tablet: 3 per slide
    return 5; // Desktop: 5 per slide
  };

  const nextCategorySlide = () => {
    const categoriesPerSlide = getCategoriesPerSlide();
    const maxSlide = categories.length - categoriesPerSlide;
    setCategorySlide((prev) => (prev >= maxSlide ? 0 : prev + 1));
  };

  const prevCategorySlide = () => {
    const categoriesPerSlide = getCategoriesPerSlide();
    const maxSlide = categories.length - categoriesPerSlide;
    setCategorySlide((prev) => (prev <= 0 ? maxSlide : prev - 1));
  };

  // Add useEffect for responsive handling
  useEffect(() => {
    const handleResize = () => {
      setCategorySlide(0); // Reset slide on resize
    };
  ...
  const fetchData = async () => {
    try {
      ...
      const bestSellersResponse = await axios.get(
        "https://astroanikantbackend-2.onrender.com/product/bestsellers"
      );
  ...
  const nextProductSlide = () => {
    ...
    setProductSlide(
      (prev) => (prev + 1) % Math.ceil(bestsellers.length / productsPerSlide)
    );
  };
  ...
  const prevProductSlide = () => {
    ...
    setProductSlide(
      (prev) =>
        (prev - 1 + Math.ceil(bestsellers.length / productsPerSlide)) %
        Math.ceil(bestsellers.length / productsPerSlide)
    );
  };
  ...
  const heroSlides = [
    {
      ...
      description:
        "Transform your life with our genuine astrological products, blessed and energized by expert astrologers",
    },
    {
      title: "Sacred Yantras for Divine Energy & Ratnas for Prosperity",
      subtitle: "Channel Positive Vibrations",
      description:
        "Experience the power of ancient symbols and sacred geometry for prosperity and protection",
    },
    {
      title: "Mystical Bracelets & Spiritual Tools",
      subtitle: "Meditation & Manifestation",
      description:
        "Enhance your spiritual journey with authentic prayer beads and meditation accessories",
    },
  ];
 ...
 const categories = [
  ...
  { 
    id: "68dca6f3b36a12dbda6d853f", 
    name: "Keychain", 
    icon: IoKeyOutline, // from react-icons/io5 - key icon
    count: "90+ Styles", 
    color: "from-yellow-500 to-amber-700" 
  },
  { 
    id: "68dca7aeb36a12dbda6d8545", 
    name: "Gemstones", 
    icon: GiCutDiamond, // from react-icons/gi - gemstone/crystal
    count: "200+ Stones", 
    color: "from-blue-500 to-cyan-600" 
  },
  { 
    id: "68dcac23b36a12dbda6d8578", 
    name: "Pendant", 
    icon: GiGemPendant, // from react-icons/gi - pendant display
    count: "150+ Designs", 
    color: "from-rose-500 to-pink-600" 
  },
  { 
    id: "68dcae8bb36a12dbda6d8581", 
    name: "Tower and Tortoise", 
    icon: GiTortoise, // from react-icons/gi - tortoise
    count: "50+ Items", 
  ...
  { 
    id: "68de4272d8a59d0022eb46b5", 
    name: "Mala", 
    icon: GiPrayerBeads, // from react-icons/gi - prayer beads
    count: "100+ Malas", 
    color: "from-amber-600 to-orange-700" 
  },
  { 
    id: "68de4a1ed8a59d0022eb46fd", 
    name: "Ring", 
    icon: GiDiamondRing, // from react-icons/gi - ring icon
    count: "120+ Rings", 
  ...
  const whyChooseUs = [
    {
      ...
      description:
        "Every item is carefully sourced and verified for authenticity by our expert astrologers",
    },
    {
      icon: Sparkles,
      title: "Spiritually Energized",
      description:
        "All products are blessed and energized according to ancient Vedic rituals before dispatch",
    },
    {
      icon: Eye,
      title: "Expert Consultation",
      description:
        "Get personalized guidance from certified astrologers to choose the right products",
    },
    {
      icon: Zap,
      title: "Worldwide Delivery",
      description:
        "Fast and secure shipping to your doorstep with careful packaging and tracking",
    },
  ];
  ...
  return (
      ...
      {showEnergizationPopup && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm animate-fade-in p-4">
          <div className="relative w-full max-w-md">
            ...
            >
              <svg
                className="w-5 h-5 sm:w-6 sm:h-6 text-[#9C0B13]"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
              ...
              <div className="relative z-10 text-center pt-4 sm:pt-6">
                ...
                <div className="bg-gradient-to-r from-[#FEF7D7]/10 to-yellow-200/10 rounded-2xl p-6 mb-6 border border-[#FEF7D7]/20">
                  <p className="text-[#FEF7D7] text-base leading-relaxed mb-4">
                    ...
                    in our sacred temple with proper mantras and rituals before
                    reaching you.
                  </p>
                ...
                <div className="mt-4">
                  ...
                  <p className="text-[#FEF7D7]/60 text-xs mt-2">
                    Auto-closing...
                  </p>
                </div>
              </div>
        ...
        <div className="relative z-10 container mx-auto px-6 text-center text-white">
          <div className="transform transition-all duration-1000 animate-fade-in">
            ...
            <div className="space-y-4 md:space-y-0 md:space-x-6 md:flex md:justify-center">
              <button
                className="group relative px-8 py-4 bg-gradient-to-r from-[#FEF7D7] to-yellow-200 text-[#9C0B13] rounded-full font-bold text-lg transform hover:scale-105 transition-all duration-300 shadow-2xl hover:shadow-[#FEF7D7]/50"
              ...
              <button
                className="px-8 py-4 border-2 border-[#FEF7D7] text-[#FEF7D7] rounded-full font-bold text-lg hover:bg-[#FEF7D7] hover:text-[#9C0B13] transition-all duration-300 shadow-lg"
        ...
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Discover our curated collection of authentic spiritual products
              for your cosmic journey
            </p>
            <div className="w-24 h-1 bg-gradient-to-r from-[#9C0B13] to-red-400 mx-auto mt-6"></div>
          </div>

          {/* Replace the entire categories section div with this slider version */}
          <div className="relative px-12">
            {/* Previous Button */}
            <button
              onClick={prevCategorySlide}
              className="absolute left-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 md:w-12 md:h-12 bg-[#9C0B13] text-[#FEF7D7] rounded-full flex items-center justify-center hover:bg-red-700 transition-all duration-300 shadow-lg hover:scale-110"
            ...
            <button
              ...
              className="absolute right-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 md:w-12 md:h-12 bg-[#9C0B13] text-[#FEF7D7] rounded-full flex items-center justify-center hover:bg-red-700 transition-all duration-300 shadow-lg hover:scale-110"
              ...
              <div
                ...
                style={{
                  transform: `translateX(-${
                    categorySlide * (100 / getCategoriesPerSlide())
                  }%)`,
                }}
              >
                {categories.map((category, index) => (
                  <div
                    key={category.id}
                    className="w-full md:w-1/3 lg:w-1/5 flex-shrink-0 px-3"
                  >
                    <div
                      className={`group relative p-6 md:p-8 bg-white rounded-3xl shadow-xl hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-500 cursor-pointer overflow-hidden h-full ${
                        isVisible.categories
                    ...
                    >
                      ...
                      <div className="relative mb-4 md:mb-6 flex justify-center">
                        <div
                          className={`w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br ${category.color} rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg`}
                        >
                      ...
                      <div className="relative text-center">
                        <h3 className="text-lg md:text-xl font-bold text-[#9C0B13] mb-1 md:mb-2 group-hover:text-gray-800 transition-colors duration-300 line-clamp-2 min-h-[3.5rem]">
                          {category.name}
                        </h3>
            ...
            <div className="flex justify-center mt-8 space-x-2">
              {[...Array(categories.length - getCategoriesPerSlide() + 1)].map(
                (_, index) => (
                  <button
                    key={index}
    ...
    <p className="text-gray-500 text-sm">
      Showing {categorySlide + 1}-{Math.min(categorySlide + getCategoriesPerSlide(), categories.length)} of {categories.length} categories
    </p>
  </div> */}
          </div>
        </div>
        ...
        <div className="container mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-[#FEF7D7]/80 max-w-3xl mx-auto mb-6">
              Can't find what you're looking for? Tell us about the spiritual
              product you need and we'll help you find it or create a custom
              solution
            </p>
            ...
            <div className="space-y-8">
              ...
              <div className="text-center pt-6">
                ...
                <p className="text-[#FEF7D7]/70 mt-4 text-sm">
                  We'll get back to you within 24 hours with availability and
                  pricing information
                </p>
              </div>
            </div>
          ...
          <div className="text-center">
            <div className="bg-gradient-to-br from-yellow-400/20 to-amber-500/20 rounded-2xl p-8 border border-yellow-300/30">
              <h3 className="text-2xl font-bold text-[#FEF7D7] mb-4">
                What Happens Next?
              </h3>
              <div className="grid md:grid-cols-3 gap-6 text-[#FEF7D7]/90">
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-sm font-medium">
                    We review your request and search our network
                  </p>
                </div>
                <div className="flex flex-col items-center">
                  <div className="w-12 h-12 bg-yellow-400 rounded-full flex items-center justify-center mb-3">
                  ...
                  <p className="text-sm font-medium">
                    Our experts find or create the perfect match
                  </p>
                </div>
                <div className="flex flex-col items-center">
                  <div className="w-12 h-12 bg-yellow-400 rounded-full flex items-center justify-center mb-3">
                  ...
                  <p className="text-sm font-medium">
                    We contact you with availability and pricing
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="relative">
            ...
            <div className="overflow-hidden">
              <div
                ...
                style={{
                  transform: `translateX(-${
                    productSlide * (100 / getProductsPerSlide())
                  }%)`,
                }}
              >
                {loading
                  ...
                  : bestsellers.map((product, index) => (
                      <div
                        key={product._id}
                        className="w-full md:w-1/2 lg:w-1/4 flex-shrink-0 px-2 md:px-4"
                      >
                        <div
                          className={`group bg-white rounded-3xl shadow-xl hover:shadow-2xl transform hover:-translate-y-3 transition-all duration-500 overflow-hidden cursor-pointer h-full ${
                            isVisible.bestsellers
                              ? `animate-fade-in-up delay-${index * 150}`
                              : ""
                          }`}
            ...
            {!loading && bestsellers.length > 4 && (
              <div className="flex justify-center mt-8 space-x-2">
                {[
                  ...Array(
                    Math.ceil(bestsellers.length / getProductsPerSlide())
                  ),
                ].map((_, index) => (
                  <button
                    key={index}
        ...
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-[#FEF7D7]/80 max-w-2xl mx-auto">
              Your trusted partner in spiritual transformation and cosmic
              alignment
            </p>
...
<style jsx>{`
  ...
  @keyframes glow {
    0%,
    100% {
      text-shadow: 0 0 20px rgba(254, 247, 215, 0.5);
    }
    50% {
      text-shadow: 0 0 30px rgba(254, 247, 215, 0.8);
    }
  }
